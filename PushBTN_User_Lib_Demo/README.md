...
Project này sử dụng hai thư viện tự viết là PushBTN và LED:
- `PushBTN.h` Để đọc phím bấm các tình huống khác nhau (single click, hold). Mã chương trình đã có chức năng khử rung (debouncing) phím.
